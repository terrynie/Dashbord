var Chart = function(s) {
    ...
    window.devicePixelRatio && (s.canvas.style.width = "100%", s.canvas.style.height = "50%", s.canvas.height = u * window.devicePixelRatio, s.canvas.width = q * window.devicePixelRatio, s.scale(window.devicePixelRatio, window.devicePixelRatio));
